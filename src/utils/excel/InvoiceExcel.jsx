// utils/excel/InvoiceExcel.js
import ExcelJS from "exceljs";
import ColorLogo from "../../assets/Excel/ColorLogo.png";

const InvoiceExcel = async (invoiceData, setLoading, triggerNotification, projectName) => {
  try {
    setLoading(true);
    ...
    const worksheet = workbook.addWorksheet("Invoice SD RM Release");
    ...
    worksheet.getCell("A2").value = "INVOICE SD RM RELEASE";
    ...
    const sectionHeader = worksheet.addRow(["Invoice SD RM Release Details"]);
    ...
    const excelFileName = `${projectName || 'Project'} - Invoice SD RM Release - ${dateStr}.xlsx`;
