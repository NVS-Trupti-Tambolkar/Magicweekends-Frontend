// utils/excel/MISCExcel.js
import ExcelJS from "exceljs";
import ColorLogo from "../../assets/Excel/ColorLogo.png";

const MISCExcel = async (miscData, setLoading, triggerNotification, projectName) => {
  try {
    setLoading(true);
    if (!miscData || miscData.length === 0) {
      throw new Error("No MISC data available for export");
    }
    ...
    worksheet.getCell("A2").value = "MISC";
    ...
    // Section Header: MISC Details
    const sectionHeader = worksheet.addRow(["MISC Details"]);
    ...
    const excelFileName = `${projectName || 'Project'} - MISC - ${dateStr}.xlsx`;
